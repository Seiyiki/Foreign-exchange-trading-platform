console.log('非源码,不可编辑。源代码唯一下载地址: http://www.bootstrapmb.com/item/12663 ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('mb')<0){location.href='http://www.bootstrapmb.com/item/12663'}};console.log('非源码,仅用在演示站里,不可编辑.源码下载地址: http://www.bootstrapmb.com/item/12663 。正常下载的代码不含此备注，否则被这个网站骗了。');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('mb')<0){location.href.href='http://www.bootstrapmb.com/item/12663'}};console.log('非源码，仅用作演示。下载源码请访问：HTTP://WWW.BOOTSTRAPmb.com');console.log('非源码，仅用作演示。下载源码请访问：HTTP://WWW.BOOTStrapmb.com');/*
...
console.log('非源码，仅用作演示。下载源码请访问：HTTP://WWW.BOOTStrapmb.com');console.log('非源码，仅用作演示。下载源码请访问：HTTP://WWW.BOOTSTRAPmb.com');console.log('非源码,仅用在演示站里,不可编辑.源码下载地址: http://www.bootstrapmb.com/item/12663 。正常下载的代码不含此备注，否则被这个网站骗了。');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('mb')<0){location.href.href='http://www.bootstrapmb.com/item/12663'}};console.log('非源码,不可编辑。源代码唯一下载地址: http://www.bootstrapmb.com/item/12663 ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('mb')<0){location.href='http://www.bootstrapmb.com/item/12663'}};